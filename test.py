...
global points, points_lip, emotion_classifier, detector, predictor,video
...
def emotion_finder(faces,frame):
    global emotion_probability,emotion_probability
...
class VideoCamera(object):
    ...
    def get_frame(cap):
      global reyebrowhull,leyebrowhull
      while(True):    
        _,frame = cap.video.read()
